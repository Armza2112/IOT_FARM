...
void post_uuid()
{
    ...
    esp_http_client_config_t config = {
        .url = "http://192.168.1.157:4000/device/uuid",
...
void post_time_set()
{
    ...
    if (connect)
    {
        if (!time_correct)
        {
            ...
            esp_http_client_config_t config = {
                .url = "http://192.168.1.157:4000/device/time_set",
                .method = HTTP_METHOD_POST,
                // .crt_bundle_attach = esp_crt_bundle_attach,
                .timeout_ms = 10000,
            };
...
{
    esp_http_client_config_t config = {
        .url = "http://192.168.1.157:4000/device/get/reg",
...
{
    esp_http_client_config_t config = {
        .url = "http://192.168.1.157:4000/device/get/data",
        .method = HTTP_METHOD_GET,
        .timeout_ms = 10000,
    };
