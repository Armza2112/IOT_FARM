...
// void do7019_spiffs(float temp, float oxygen, float do_value, const char *time_str);
...
void add_sensor_reading(float temp, float oxygen, float do_value, const char *time_str)
{
...
void do7019_task()
{
    ...
    while (1)
    {
        ...
        // do7019_spiffs(30.0, 20, 20, time_str);      // test value
        add_sensor_reading(30.0, 20, 20, time_str); // test value
...
//     {
//         fprintf(f,
//                 "{\"time\":\"%s\",\"temp\":%.2f,\"o2\":%.2f,\"do\":%.2f}\n",
//                 time_str, temp, oxygen, do_value);
//         fclose(f);
